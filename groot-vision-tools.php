...
define('GV_TOOLS_VERSION', '2.2.0'); // هر بار نسخه جدید منتشر می‌کنید، این عدد را هم مثل بالای فایل تغییر دهید
/*
|--------------------------------------------------------------------------
| لود داشبورد اصلی
|--------------------------------------------------------------------------
...
require_once GV_PLUGIN_DIR . 'modules/maintenance.php'; // حالت تعمیر
